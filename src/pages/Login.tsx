...
const Login = forwardRef<HTMLDivElement>((_, ref) => {
  ...
  const anyLoading = loading || redirecting || googleLoading || appleLoading;

  return (
    <div ref={ref} className="min-h-[100dvh] flex items-center justify-center bg-gradient-to-br from-secondary via-background to-secondary/40 p-4">
      <SEOHelmet title="Sign In — BexMatch" description="Sign in to BexMatch and continue your journey to find love." />
      <motion.div
      ...
      >
        <div className="bg-card rounded-3xl shadow-card border border-border/50 p-7 sm:p-8">
          {/* Back link */}
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-1.5 text-sm">Sign in to continue finding love</p>
          </div>
